...
import { loadUniversityByWordFra } from './universitiesSliceFra';
import { useEffect, useState } from 'react';
import styles from './UniversitiesListFra.module.css';
...
export default function UniversitiesListFra(): JSX.Element {
	...
	useEffect(() => {
		dispatch(loadUniversityByWordFra(word));
	}, [dispatch, word]);
	...
	return (
		<div className={styles.container}>
			...
			<h1 className={styles.title}>Universities of France </h1>
			<div>
				<input
